from src.algoritmos_evolutivos.Algoritmo_genetico_avanzado import Algoritmo_genetico_avanzado
from src.algoritmos_evolutivos.Algoritmo_genetico_basico import Algoritmo_genetico_basico
...
def exercise3(seed=0, tasks=0, resources=0, task_duration=[], task_resource=[], task_dependencies=[]):
    ...
    """
    return Algoritmo_genetico_basico.iniciar(seed, tasks, resources, task_duration, task_resource, task_dependencies)
...
def exercise4(seed=0, tasks=0, resources=0, task_duration=[], task_resource=[], task_dependencies=[]):
    ...
    :return: list with the start time of each task in the best solution found, or empty list if no solution was found
    """
    return Algoritmo_genetico_avanzado.iniciar(seed, tasks, resources, task_duration, task_resource, task_dependencies)
