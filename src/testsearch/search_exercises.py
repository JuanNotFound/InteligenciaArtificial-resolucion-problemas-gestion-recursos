from src.algoritmos_busqueda.A_estrella import A_estrella
from src.algoritmos_busqueda.Branch_and_bound import Branch_and_bound
...
def exercise1(tasks=0, resources=0, task_duration=[], task_resource=[], task_dependencies=[]):
    ...
    """
    return Branch_and_bound.iniciar(tasks, resources, task_duration, task_resource, task_dependencies)
...
def exercise2(tasks=0, resources=0, task_duration=[], task_resource=[], task_dependencies=[]):
    ...
    :return: list with the start time of each task in the best solution found, or empty list if no solution was found
    """
    return A_estrella.iniciar(tasks, resources, task_duration, task_resource, task_dependencies)
